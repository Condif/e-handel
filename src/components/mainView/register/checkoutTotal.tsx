			...
			<Grid container xs={12}>
				...
				<Grid item xs={6}>
					<Typography variant="body1">
						{`${props.itemTotal.itemAmount} Items: excl. VAT: ${(
							props.itemTotal.totalValue * 0.8
						).toFixed(2)}:-`}
					</Typography>
					<Typography variant="body1">
				...
				<Grid item container xs={6} direction="row" alignItems="center" justify="center" style={{borderLeft:"1px solid #0002"}}>
						<Typography variant="h6" align="center">
							{`Total: ${
								typeof props.delivery.price === "number"
									? (props.itemTotal.totalValue + props.delivery.price).toFixed(
											2
									  )
									: null
							}`}
				...
				<Grid
					...
					justify="center">
					<Button
						disabled={typeof props.delivery.price === "number" ? false : true}
						variant="contained"
						color="primary"
